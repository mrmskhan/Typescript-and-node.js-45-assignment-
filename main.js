...
// let personName:string= "M. Saleem Khan";
// // in lowercase
...
// let faveriteNumber:number= 4;
// console.log(`my faveritenumber is ${faveriteNumber}`);
// //Question(10)
...
// //Author: [Muhammad Saleem Khan]
// //Date: [jun 01, 2024]
// //Queation 9 print my favorite number.
// let faveriteNumber:number= 4;
...
// let friendsName:string[]=["Asif","Amir","Adil","Danish"];
...
// let transport:string[]=["honda cd70","suzuki cultus","kia sportage"];
...
// let guest:string[]=["Asif","Amir","Adil","Danish"];
...
// let guest:string[]=["Asif","Amir","Adil","Danish"];
// let canNotAttend:string="Asif";
// console.log(canNotAttend+" "+"can not attend the dinner.")
// let newGuest:string="shahzad"
...
// let guest:string[]=["shahzad","Amir","Adil","Danish"];
// let canNotAttend:string="Amir"
// let newGuest:string ="khurram"
// guest[guest.indexOf(canNotAttend)]=newGuest;
// console.log(guest)
// guest.map((items)=>
// console.log(`dear ${items}, i found a bogger dinner table so i am invited more peoples.`))
// //Question (16) part 2
// //• Add one new guest to the beginning of your array.
// let guestBig:string="ghaffar"
// guest.unshift(guestBig);
// console.log(guest)
// //Question (16) part 3 Middle
// //• Add one new guest to the middle of your array.
// let guestmid:string="rashid"
// let Indexmid = guest.length/3
// guest.splice(Indexmid,0,guestmid)
// console.log(guest)
// //Question (16) part 4 Append
...
// let guest:string[]=["shahzad","Amir","Adil","Danish"];
// console.log("due to limited space,only two person can be invited for donner.");
// // informing that only two person can be invited
// let guest:string[]=["shahzad","Amir","Adil","Danish"];
// while (guest.length >2){
// let removedGuest = guest.pop();
// console.log(`sorry, ${removedGuest}, you are no longer invited to donner.`);
// }
// //invitation to the remaining to person
// let guest:string[]=["shahzad","Amir"];
// guest.forEach((guest)=>{
...
// let visit:string[]=["japan","india", "dubai", "china","america"];
// console .log("original order", visit);
// // //• Store the locations in a array. Make sure the array is not in alphabetical order.
// console.log("alfabetical order:",[...visit].sort());
// // //• Print your array in its original order.
// console.log("original order after alfabetical sorting:",visit)
// // //• Print your array in alphabetical order without modifying the actual list.
// console.log("reverse alfabetical order:",[...visit].sort().reverse());
// // //• Show that your array is still in its original order by printing it.
// console.log("original order after reverse sorting:",visit);
// // //• Print your array in reverse alphabetical order without changing the order of the original list.
// console.log("reversed order:",visit);
// // //• Show that your array is still in its original order by printing it again.
// // //• Reverse the order of your list. Print the array to show that its order has changed.
// // //• Reverse the order of your list again. Print the list to show it’s back to its original order.
// console.log("back to original order:",visit);
// // //• Sort your array so it’s stored in alphabetical order. Print the array to show that its order has been changed.
// visit.sort();
// console.log("sorted in alphabetical order:",visit);
// // //• Sort to change your array so it’s stored in reverse alphabetical order. Print the list to show that its order has changed.
// visit.sort((a,b)=> b.localeCompare(a));
// console.log("sorted in reverse alphabetical order:",visit);
// //Question (19)
// //Dinner Guests: Working with one of the programs from Exercises 14 through 18, print a message indicating the number of 
// //people you are inviting to dinner.
// console.log("we had finally invited",guest.length,"person from exercise no. 14")
// //Question (20)
...
// let country:string [] = ["pakistan","india","japan","usa","china"];
// console.log("list of country:");
// console.log(country);
// //Question (21)
// //They think of something you could store in a TypeScript Object. Write a program that creates Objects containing these items.
// let stud: {name:string,age:number,contact:number} = {name:"saleem", age:40, contact: 3472400889};
// console.log(stud)
// //Question (22)
...
// let days:string []=["sunday","monday","tuesday","wednesday","thurtsday","friday","saturday"]
// // console.log(days{7});
// console.log(days[6])
// //Question (23)
...
// console.log(car.length != 6)
// console.log("is 5 <= 10 ? predict true")
// console.log(5 <= 10)
...
// let name_1:string ="saleem"
// let name_2:string ="ayan"
// let name_3:string ="maria"
// if (name_1 == name_3){
...
//     console.log("elgible for vote")
// }else{
//     console.log("vote in older category")
// }
// if (age_1 <= age_2){
//     console.log("younger")
// }
...
//     console.log("older")
// }
// if (age_1 == 19 && age_2 == 25){
//     console.log("both are eligible for vote")
// }
// if (age_1 == 19 || age_2 != 25){
//     console.log("both are eligible not for vote")
// }
...
// let favorite_fruits:string[]=["kivi","orange","apples","peach","berry"]
...
// let users : string [] = ["admin","saleem","mani","ayan","maria"]
...
// let current_users : string [] = ["Admin","Saleem", "Ayan", "Mani", "Maria"]
// let new_users : string [] = ["Admin","Maria", "Saim", "Abrish", "Hoorab"]
...
// console.log("\n i really love pizza!")
// //Question (35)
// //Animals: Think of at least three different animals that have a common characteristic. Store the names of these animals in 
...
// let fav_animal:string []=["elephant","dog","lion","cat","rabbit"]
// for (let animal of fav_animal){
//     console.log(animal)
// }
// console.log("\n")
// for(let animal of fav_animal){
...
// }
// console.log("\n all of these are great pets! but i love rabbit more"   )
// //Question (36)
...
// //simple sentence, such as Karachi is in Pakistan. 
// //Give the parameter for the country a default value. Call your function for three different cities, at least one of which is 
...
// //an artist name and an album title, 
// //and it should return a Object containing these two pieces of information. Use the function to make three dictionaries 
// //representing different albums. Print 
// //each return value to show that Objects are storing the album information correctly. Add an optional parameter to 
...
// //album’s Object. Make at least one new 
...
//     return dictionaries;
// }
// let album = make_Album("maria", "red wave")
// console.log(album)
// album = make_Album("saleem", "seenbreez")
// console.log(album)
// album = make_Album("mani", "light")
// console.log(album)
// //Question (41)
...
//     }
// }
// const magician:string[] = ["maria", "saleem","mani"];
...
//     }
// }
// const magicians2: string [] = ["maria", "saleem", "mani"];
...
// //magicians’ names. Because the original 
// //array will be unchanged, return the new array and store it in a separate array. Call show_magicians() with each array 
// //to show that you have one array of the 
...
// }
// const magicians3:string[] = ["maria","saleem","mani"]
// const magicians2:string[] = make_great2(magicians3);
// show_magicians(magicians3);
// show_magicians(magicians2);
// //Question (44)
// //Sandwiches: Write a function that accepts a array of items a person wants on a sandwich. The function should have one 
// //parameter that collects as many items 
// //as the function call provides, and it should print a summary of the sandwich that is being ordered. Call the function 
// //three times, using a different number 
...
//     }
// }
// console.log("enjoy your sandwich saleem khan")
//     sandwich(`tomaato`, `capsicum`,`chicken`)
//     sandwich(`beef`, `chees`,)
...
// //and a model name. It should then 
// //accept an arbitrary number of keyword arguments. Call the function with the required information and two other name-value 
// //pairs, such as a color or an 
